...
Server::Server(Server const &other)
 : srv_sockaddr(other.srv_sockaddr), server_names(other.server_names),
   ...
   routes(other.routes), port(other.port), host(other.host), timeout(other.timeout),
   listen_fd(other.listen_fd), is_default(other.is_default), server_name(other.server_name),
   default_error_pages(other.default_error_pages), client_body_size(other.client_body_size) {
